...
(function(g, h) {
    ...
    c.fn.find = function(b) {
        ...
        if (e) if (document.getElementsByClassName) e = d.getElementsByClassName(e);
            ...
            for (var a = b = 0,
            f = [], d = (d || document).getElementsByTagName("*"), k = d.length, e = RegExp("(^|\\s)" + e + "(\\s|$)"); b < k; b++) e.test(d[b].className) && (f[a] = d[b], a++);
            e = f
    ...
    c.fx.tick = function() {
        for (var b = c.timers,
        d = 0; d < b.length; d++) ! b[d]() && b.splice(d--, 1); ! b.length && c.fx.stop()
    };
    c.fx.stop = function() {
    ...
    c.fn.stop = function() {
        for (var b = c.timers,
        d = b.length - 1; 0 <= d; d--) b[d].elem === this[0] && b.splice(d, 1);
        return this
    };
    return c
    ...
    b.fn = b.prototype = {
        ...
        _init: function(a) {
            ...
            if($(a.content).hasClass("aui_loading")){
				a.content="<div class='aui_content_inner' style='height:auto;overflow-y:auto'>"+a.content+"</div>";
			}else{
            	 a.content="<div class='aui_content_inner' style='height:"+a.height+"px;overflow-y:auto'>"+a.content+"</div>";
            }
        ...
        size: function(a, b) {
            ...
            var cheight=g.height;
            if(d[0].offsetHeight>(document.body.clientHeight-99)){
            	 /***2016-9-3设置弹窗高度，99为加上网站头部高度***/
        ...
        _getDOM: function() {
            ...
            c = document.body;
            var hasUrl=a.baseURI?a.bsaeURI:null;
        ...
        function() {
            for (var a = 0,
            c, d, e = b.defaults.path + "/skins/",
            g = this.DOM.wrap[0].getElementsByTagName("*"); a < g.length; a++) if (c = g[a], d = c.currentStyle.png) d = e + d,
            c = c.runtimeStyle,
        ...
        _runScript: function(a) {
            for (var b, c = b = 0,
            a = a.getElementsByTagName("script"), d = a.length, e = []; b < d; b++) if ("text/dialog" === a[b].type) e[c] = a[b].innerHTML,
            c++;
    ...
    b.defaults = {
        ...
        left: "50%",
        top: "38.2%",
        zIndex: 1000000000,//页面head设置值太大，重置zindex
        resize: !0,
        drag: !0
    };
