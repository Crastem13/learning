$(function() {
    ...
    //导航语言
    $("body").click(function () {
        if($('.laguage_div').hasClass('ulShow')){
            console.log("aa");
...
//about autel新闻点more
    ...
    for(i=0;i<=stitle_len;i++){
        ...
        if(sTitle.length>140 ){
            sTitle = sTitle .substring(0,120)+"<a class=\"red_text\">...more<span class=\"db_arrow-icon\"></span></a>";
...
//Safari
    ...
    if(browser[0] == "chrome/30.0.0.0"){
        ...
        if(blw<769){
            ...
            $(".footer_box h4").css("font-weight","900");
            $(".dt_content_item .red_button , .page_header_nav a , .join_post .post_item ").css("padding-bottom","13px");
            ...
            $(".header_right_item h6").css("padding-bottom","5px");
            $(".footer_box h4").css("font-weight","900");
        }else if(blw == 960){
    ...
    }else if(browser[0] == "chrome/71.0.3578.99"){
        if(blw==400){
            $(".footer_box h4").css("font-weight","900");
        }
    }else if(browser[0] == "safari/605.1.15"){
        // $(".footer_box_title").css("padding-left","10px");
    }
