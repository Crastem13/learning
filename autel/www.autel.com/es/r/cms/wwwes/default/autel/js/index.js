...
//about autel新闻点more
    ...
    for(i=0;i<=stitle_len;i++){
        ...
        if(sTitle.length>140 ){
            sTitle = sTitle .substring(0,140)+"<a class=\"red_text\">…VER MÁS<span class=\"db_arrow-icon\"></span></a>";
    ...
    $(".abus_mid_frist_item").on('click',".red_text", function() {
        ...
        $(this).parent("p").html(allText+"<a class=\"short_content\">VER MÁS<span class=\"db_arrow-icon\"></span></a>");
    });
...
//Safari
    ...
    if(browser[0] == "chrome/30.0.0.0"){
        ...
        $(".header_logo").css("paddingRight","0%");
        $(".header_left_item").css("paddingRight","10px");
        $(".header_left_item").css("paddingLeft","10px");
        $(".header_right_item h6").css("marginRight","20px");
        $(".ln_box img").css("width","400px");
        $(".ln_item_text").css("width","430px");
        $(".dc3_title p").css("marginLeft","2px");
        if(blw<769){
            $(".page_banner h2").css("paddingTop","120px");
            $(".email_box input").css("top","0%");
    ...
    }else if(browser[0].indexOf("firefox") >= 0){
        $("#autel_video_1").css("height","auto");
    }
